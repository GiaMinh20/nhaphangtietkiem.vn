...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <div class="ad-table-report responsive-tb">
                                        <table class="table tb-border  highlight striped   ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Tổng tiền ship nội địa Trung Quốc</td>
                                                    <td class="no-wrap">
                                                        <div style="justify-content: space-between">
                                                            <span class=" font-weight-400">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-wrap">
                                                        <div style="justify-content: space-between">
                                                            <span class=" font-weight-400">
                                                                <asp:Label ID="lblTotalPriceReal" runat="server"></asp:Label>                                                                
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Tổng tiền lời</td>
                                                    <td class="no-wrap">
                                                        <div style="justify-content: space-between">
                                                            <span class=" font-weight-400">
                                        ...
                                        <table class="table highlight tb-border ad-rp-checkout">
                                            <thead>
                                                <tr class="teal darken-4">
                                                    ...
                                                    <th class="white-text">Tiền hàng Web</th>
                                                    <th class="white-text">Tiền ship TQ</th>
                                                    <th class="white-text">Tiền mua thật</th>
    ...
    <script>
        ...
        if (dataCountry != null || dataCountry != "") {
            ...
            countryRevenueChartData.datasets[0].backgroundColor[3] = red_orange_gradient;
