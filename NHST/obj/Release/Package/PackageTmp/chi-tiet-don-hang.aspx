                                                    ...
                                                    <div class="responsive-tb">
                                                        <table class="table    highlight bordered  centered   ">
                                                            <thead>
                                                                <tr>
                                                                    <th>Mã vận đơn</th>
                                                                    <th>Cân nặng thực tế (kg)</th>
                                                                    <th>Cân nặng quy đổi (kg)</th>
                                                                    <th>Cân nặng tính tiền (kg)</th>
                                                ...
                                                <div id="order-list" class="section scrollspy order-list account-site">
                                                    <div class="title-header bg-dark-gradient">
                                                        <h6 class="white-text ">Danh sách sản phẩm                                                        
                                                            (<asp:Literal ID="ltrCountProducts" runat="server"></asp:Literal>)
                                                        </h6>
                                                    </div>
                                                    ...
                                                    <div style=" display: flex; justify-content: center; font-weight: bold; font-size: 1.5rem; color: black; ">
                                                        <span>Tổng Mua =
                                                            <asp:Literal ID="ltrCountProducts2" runat="server"></asp:Literal>
                                                            sản phẩm</span>
                                                    </div>
                                                </div>
                                            </div>
