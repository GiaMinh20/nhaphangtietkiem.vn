...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="main" class="main-full">
        <div class="row">
            ...
            <div class="fixfix" style="display:flex; padding: 0 2rem;">
                <span style="font-size:20px; font-weight:bold; color:black;">Tổng tiền khách đã nạp: <asp:Label ID="lblTotalPrice" runat="server"></asp:Label></span>
            </div>
