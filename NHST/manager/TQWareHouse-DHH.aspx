...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script type="text/javascript">
                                        ...
                                        for (var i = 0; i < listSmallpackage.length; i++) {
                                            ...
                                            if (data.OrderTypeInt != 2) {
                                                ...
                                                if (check == false) {
                                                    ...
                                                    html += "<th style=\"min-width: 100px;\">NV Kho Check</th>";
                                                    //Thêm ghi chú kho
                                                    html += "<th style=\"width: 100px;\">Kho ghi chú</th>";
                                              ...
                                              <%--  var selectedbigpack = parseFloat($("#<%=ddlBigpackage.ClientID%> option:selected").val());--%>
                                                    ...
                                                    //Thêm ghi chú kho
                                                    html += "<td>";
                                                    html += "<textarea name=\"\" class=\"tb-textarea packageWarehouseNote\" rows=\"5\">" + data.WarehouseNote + "</textarea>";
                                                    html += "</td>";
        ...
        function updateWeight(barcode, obj, packageID) {
            ...
            var base64 = "";
            var warehouseNote = obj.parent().parent().parent().find(".packageWarehouseNote").val();
            ...
            $.ajax({
                ...
                data: "{barcode:'" + barcode + "',quantity:'" + quantity + "',status:'" + status + "',BigPackageID:'"
                    ...
                    + "',loaisanpham:'" + producttype + "',base64:'" + base64 + "',description:'" + description + "',warehouseNote:'" + warehouseNote + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
                    var data = msg.d;
