...
namespace NHST.Models
{
    ...
    public partial class NHSTEntities : DbContext
    {
        ...
        public virtual ObjectResult<ReportIncomeExcel_Result> ReportIncomeExcel(string fromdate, string todate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ReportIncomeExcel_Result>("ReportIncomeExcel", fromdateParameter, todateParameter);
        }
